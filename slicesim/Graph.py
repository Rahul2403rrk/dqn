...
class Graph:
    ...
    # Add this line to include base stations in the legend
            self.ax.plot(bs.coverage.center[0], bs.coverage.center[1], marker='o', color=bs.color, 
                 label=f"Base Station {bs.id}", linestyle='None')
